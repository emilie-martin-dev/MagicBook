...
public class RequirementComponent extends VBox {
	...
	public GridPane createMoneyPane() {
		...
		moneyListComponent.createAddItemLink(moneyComboBox);
		moneyListComponent.createAddItemView();
		moneyListComponent.createItemEditingLinkPane();
	...
	public GridPane createItemPane(){
		...
		itemListComponent.createAddItemLink(itemComboBox);
		itemListComponent.createAddItemView();
