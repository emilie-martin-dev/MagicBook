...
public class BookNodeWithChoices extends AbstractBookNodeWithChoices<BookNodeLink> {
	...
	public BookNodeWithChoices(String text, Integer nbItemsAPrendre, List<BookItemsLink> itemLinks, List<BookItemsLink> shopItemLinks, List<BookNodeLink> choices){
